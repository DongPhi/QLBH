...
class Authentication extends CI_Controller
{
    ...
    public function index()
    {
        ...
        if ($this->input->post('login')) {
            ...
            if ($this->form_validation->run() == true) {
                ...
                $this->cms_common_string->cms_redirect(CMS_BASE_URL . 'pos');
            }
        }
    ...
    {
        if ($this->auth == null) $this->cms_common_string->cms_redirect(CMS_BASE_URL . '/qlibanhangonline');
        CMS_Cookie::delete('user_logged' . CMS_PREFIX);
        $this->cms_common_string->cms_redirect(CMS_BASE_URL . '/qlibanhangonline');
    }
}