            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group clearfix row">
                        ...
                        <input type="text" id="prd_code" value="<?php if (isset($data['_detail_product'])) echo $data['_detail_product']['prd_code'] ?>" class="form-control col-md-9" placeholder="Mã hàng tự động" />
                    </div>
                    <div class="form-group clearfix row">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group clearfix">
                                <div class="col-md-6 padd-left-0">
                                    ...
                                    <input type="text" id="prd_sls" 
                                    value="<?php if (isset($data['_detail_product'])) echo $data['_detail_product']['prd_sls'] ?>" placeholder="0"
